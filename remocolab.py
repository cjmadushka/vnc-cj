...
def _setupSSHDImpl(ngrok_token, ngrok_region):
  ...
  root_password = "shashika"
  user_password = "shashika"
  user_name = "cj"
  print("_"*60)
  print("‾"*60)
...
print("_"*56)
print("‾"*56)
print("Script By https://github.com/cjmadushka/ ")
print("")

print("contact me @: https://t.me/CJmadushka")
print("           @: http://fb.me/cjmadushka2")
print("           @: https://wa.me/0715586492")
print("█▀▀▀▀▀█ ▀▀    ▀ ▄ █▀▀▀▀▀█")
print("█ ███ █ █▄ █▀█▀▄█ █ ███ █")
print("█ ▀▀▀ █ ▀█▀▀▄▄▄▀  █ ▀▀▀ █")
print("▀▀▀▀▀▀▀ ▀▄▀▄▀ ▀▄█ ▀▀▀▀▀▀▀")
